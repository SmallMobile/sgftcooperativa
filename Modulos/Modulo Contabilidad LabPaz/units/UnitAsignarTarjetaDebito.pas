...
uses
  ...
  pr_Classes, JvComponent, JvArrowBtn, Menus;
...
uses unitdmGeneral,UnitGlobales, UnitGlobalesCol, UnitdmCaptacion, UnitDmColocacion;
...
begin
        ...
        begin
            ...
            Close;
            SQL.Clear;
            SQL.Add('select * from "cap$tarjetarangos" where :PROMEDIO BETWEEN DESDE AND HASTA');
