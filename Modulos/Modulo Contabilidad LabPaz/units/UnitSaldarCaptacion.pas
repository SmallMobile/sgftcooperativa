...
begin
        ...
        begin
          ...
          begin
               ...
               SQL.Add('PUNTOS_ADICIONALES,MODALIDAD,AMORTIZACION,"cap$maestro".ID_ESTADO,FECHA_VENCIMIENTO,FECHA_VENCIMIENTO_PRORROGA,ID_IDENTIFICACION,ID_PERSONA,');
