...
begin
      ...
      begin
       ...
       begin
        ...
        with CDorden do
        begin
           descripcion := 'Con la Participación de ' + NLetra1.Letras + '(' + inttostr(numero) + ') miembros se comprobo quórun para deliberar y tomar desiciones validas';
           Append;
           ...
           Post;
           descripcion := 'Por Acuerdo entre los miembros fue elegido como presidente al (a la) señor(a) ' + EDpresidente.Text + ' ' + EDcargo.Text ;
           Append;
           ...
           FieldValues['tipo'] := False;
           Post;
           descripcion := 'El orden del día fue puesto a consideración por parte del (de la) señor(a) ' + EDpresidente.Text + ' ' + EDcargo.Text;
