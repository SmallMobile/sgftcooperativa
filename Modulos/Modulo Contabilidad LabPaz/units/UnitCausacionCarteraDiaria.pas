...
begin
     if RGProceso.ItemIndex = 1 then begin
        with IBQuery1 do begin
          ...
          SQL.Add('"col$causaciondiaria".DEUDA,"col$causaciondiaria".ID_EDAD_ANT,"col$causaciondiaria".ID_EDAD_ACT,');
          SQL.Add('"col$causaciondiaria".ID_GARANTIA,"col$causaciondiaria".DIAS,"col$causaciondiaria".ID_AGENCIA,');
          SQL.Add('"col$causaciones".PCAPITAL AS PCAPITAL_ANT,"col$causaciones".PINTERES AS PINTERES_ANT,"col$causaciones".PCOSTAS AS PCOSTAS_ANT,');
          ...
          SQL.Add('inner join "col$causaciondiariamov" on ("col$causaciondiaria".ID_AGENCIA = "col$causaciondiariamov".ID_AGENCIA and');
          SQL.Add('"col$causaciondiaria".ID_COLOCACION = "col$causaciondiariamov".ID_COLOCACION)');
          SQL.Add('inner join "col$causaciones" on ("col$causaciondiaria".ID_AGENCIA = "col$causaciones".ID_AGENCIA and');
          SQL.Add('"col$causaciondiaria".ID_COLOCACION = "col$causaciones".ID_COLOCACION)');
          SQL.Add('where "col$causaciondiaria".FECHA_CORTE = :FECHA and "col$causaciones".FECHA_CORTE = :FECHA_ANT');
          SQL.Add('order by "col$causaciondiaria".ID_COLOCACION ASC');
          ParamByName('FECHA').AsDate := EdFechaCorte.Date;
          ParamByName('FECHA_ANT').AsDate := StrToDate('2005/12/30');
          Open;
        end
     end
     else
     begin
        with IBQuery1 do begin
          ...
          SQL.Add('"col$causaciondiariatmp".DEUDA,"col$causaciondiariatmp".ID_EDAD_ANT,"col$causaciondiariatmp".ID_EDAD_ACT,');
          ...
          SQL.Add('inner join "col$causaciondiariamov" on ("col$causaciondiariatmp".ID_AGENCIA = "col$causaciondiariamov".ID_AGENCIA and');
          SQL.Add('"col$causaciondiariatmp".ID_COLOCACION = "col$causaciondiariamov".ID_COLOCACION)');
          SQL.Add('inner join "col$causaciones" on ("col$causaciondiaria".ID_AGENCIA = "col$causaciones".ID_AGENCIA and');
          SQL.Add('"col$causaciondiaria".ID_COLOCACION = "col$causaciones".ID_COLOCACION)');
          SQL.Add('where "col$causaciondiariatmp".FECHA_CORTE = :FECHA and "col$causaciones".FECHA_CORTE = :FECHA_ANT');
          SQL.Add('order by "col$causaciondiariatmp".ID_COLOCACION ASC');
          ParamByName('FECHA').AsDate := EdFechaCorte.Date;
          ParamByName('FECHA_ANT').AsDate := strtodate('2005/12/30');
        end;
     end;
...
// Proceso Comparacion de Provision
          //      FechaAnterior := EncodeDate(YearOf(EdFechaCorte.Date),MonthOf(EdFechaCorte.Date),DayOf(EdFechaCorte.Date)-1);
               FechaAnterior := StrToDate('2005/12/30');
...
{                IBSQL6.Close;
                ...
                IBSQL6.SQL.Clear;
                IBSQL6.SQL.Add('select * from "col$causaciondiariamov" where ID_AGENCIA = :ID_AGENCIA  AND ID_COLOCACION = :ID_COLOCACION');
                IBSQL6.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                IBSQL6.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                IBSQL6.ExecQuery;
                ...
                if Interes < PIntAcum then
                  begin
                    ...
                    if IBSQL6.FieldByName('PINTERES_ANUAL').AsCurrency > 0 then
                      ...
                      RevGInteres := IBSQL6.FieldByName('PINTERES_ACT').AsCurrency - MovInteres;
                  end
                else
                 begin
                ...
                if PCostas < PCosAcum then
                  begin
                    ...
                    if IBSQL6.FieldByName('PCOSTAS_ANUAL').AsCurrency > 0 then
                      ...
                      RevGCostas := IBSQL6.FieldByName('PCOSTAS_ACT').AsCurrency - MovCostas;
                  end
                else
                 begin
                ...
                if RecCapital > 0 then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCAPITAL_ANUAL = PCAPITAL_ANUAL - :REC');
                ...
                if RecInteres > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PINTERES_ANUAL = PINTERES_ANUAL - :REC');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ...
                if RecCostas > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCOSTAS_ANUAL = PCOSTAS_ANUAL - :REC');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ...
                if RevGCapital > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCAPITAL_ACT = PCAPITAL_ACT - :REC');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ...
                if RevGInteres > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PINTERES_ACT = PINTERES_ACT - :REC');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ...
                if RevGCostas > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCOSTAS_ACT = PCOSTAS_ACT - :REC');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                ...
                if GCapital > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCAPITAL_ACT = PCAPITAL_ACT + :GASTO');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                  ...
                  if IBSQL3.RowsAffected <= 0 then begin
                    IBSQL3.Close;
                    IBSQL3.SQL.Clear;
                    IBSQL3.SQL.Add('insert into "col$causaciondiariamov" (ID_AGENCIA,ID_COLOCACION,PCAPITAL_ACT)');
                ...
                if GInteres > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PINTERES_ACT = PINTERES_ACT + :GASTO');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                  ...
                  if IBSQL3.RowsAffected <= 0 then begin
                    IBSQL3.Close;
                    IBSQL3.SQL.Clear;
                    IBSQL3.SQL.Add('insert into "col$causaciondiariamov" (ID_AGENCIA,ID_COLOCACION,PINTERES_ACT)');
                ...
                if GCostas > 0  then begin
                  IBSQL3.Close;
                  IBSQL3.SQL.Clear;
                  IBSQL3.SQL.Add('update "col$causaciondiariamov" set PCOSTAS_ACT = PCOSTAS_ACT + :GASTO');
                  IBSQL3.SQL.Add('where ID_AGENCIA = :ID_AGENCIA and ID_COLOCACION = :ID_COLOCACION');
                  IBSQL3.ParamByName('ID_AGENCIA').AsInteger := IBQuery1.FieldByName('ID_AGENCIA').AsInteger;
                  IBSQL3.ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                  ...
                  if IBSQL3.RowsAffected <= 0 then begin
                    IBSQL3.Close;
                    IBSQL3.SQL.Clear;
                    IBSQL3.SQL.Add('insert into "col$causaciondiariamov" (ID_AGENCIA,ID_COLOCACION,PCOSTAS_ACT)');
...
//Comparar Saldos y Contabilizar
               ...
               while not IBSQL3.Eof do begin
                ...
                if IBSQL3.FieldByName('PINTERES_REV').AsCurrency > 0 then begin
                  New(ar);
                  AR^.codigo := '511530000000000000';
                  AR^.nomcuenta := 'CUENTAS POR COBRAR';
                  AR^.nocuenta := 0;
                  AR^.nocredito := '';
                  AR^.tipoide := 0;
                  AR^.idpersona := '';
                ...
                if IBSQL3.FieldByName('PINTERES_GAS').AsCurrency > 0 then begin
                  New(ar);
                  AR^.codigo := '511530000000000000';
                  AR^.nomcuenta := 'CUENTAS POR COBRAR';
                  AR^.nocuenta := 0;
               ...
               while not IBSQL3.Eof do begin
                ...
                if IBSQL3.FieldByName('PCOSTAS_REV').AsCurrency > 0 then begin
                  New(ar);
                  AR^.codigo := '511530000000000000';
                  AR^.nomcuenta := 'CUENTAS POR COBRAR';
                  AR^.nocuenta := 0;
                  ...
                  AR^.tasa := 0;
                  AR^.estado := 'O';
                  AR^.credito := IBSQL3.FieldByName('PCOSTAS_REV').AsCurrency;
                  AR^.debito := 0;
                  Lista.Add(AR);
                 end;

                if IBSQL3.FieldByName('PCOSTAS_GAS').AsCurrency > 0 then begin
                  New(ar);
                  AR^.codigo := '511530000000000000';
                  AR^.nomcuenta := 'CUENTAS POR COBRAR';
                  AR^.nocuenta := 0;
                  ...
                  AR^.estado := 'O';
                  AR^.credito := 0;
                  AR^.debito := IBSQL3.FieldByName('PCOSTAS_GAS').AsCurrency;
                  Lista.Add(AR);
                 end;
                 IBSQL3.Next;
                end;   //Fin de While ibsql3
