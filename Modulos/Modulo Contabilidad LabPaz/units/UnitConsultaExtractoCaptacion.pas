...
begin
        try
          ...
          EdFechaF.Date := EdFechaF.MaxDate;
        finally
...
begin
        ...
        0: begin
            with IBExtracto do begin
             ...
             ParamByName('NUMERO_CUENTA').AsInteger := StrToInt(EdNumeroCap.Text);
             ParamByName('DIGITO_CUENTA').AsInteger := StrToInt(EdDigitoCap.Caption);
             ParamByName('FECHA1').AsDate := EncodeDate(YearOf(EdFechaI.Date),MonthOf(EdFechaI.Date),DayOf(EdFechaI.Date));
             ParamByName('FECHA2').AsDate := EncodeDate(YearOf(EdFechaF.Date),MonthOf(EdFechaF.Date),DayOf(EdFechaF.Date));
             Open;
            end;
