object frmCausacionCarteraDiaria: TfrmCausacionCarteraDiaria
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      'SELECT'
        ...
        '"col$causaciondiaria".ID_AGENCIA,"col$causaciondiaria".ID_COLOCA' +
        'CION,"col$causaciondiaria".ID_CLASIFICACION,'
      
        '"col$causaciondiaria".DEUDA,"col$causaciondiaria".ID_EDAD_ANT,"c' +
        'ol$causaciondiaria".ID_EDAD_ACT,'
      '"col$causaciondiaria".DIAS,"col$causaciondiaria".ID_AGENCIA,'
        ...
        '"col$causaciondiaria".PCAPITAL,"col$causaciondiaria".PINTERES,"c' +
        'ol$causaciondiaria".PCOSTAS,'
      
        '"col$causaciondiaria".PCAPITAL_REC,"col$causaciondiaria".PINTERE' +
        'S_REC,"col$causaciondiaria".PCOSTAS_REC,'
      
        '"col$causaciondiaria".PCAPITAL_REV,"col$causaciondiaria".PINTERE' +
        'S_REV,"col$causaciondiaria".PCOSTAS_REV,'
      
        '"col$causaciondiaria".PCAPITAL_GAS,"col$causaciondiaria".PINTERE' +
        'S_GAS,"col$causaciondiaria".PCOSTAS_GAS'
      'from "col$causaciondiaria"'
      
        'inner join "col$causaciondiariamov" on ("col$causaciondiaria".ID' +
        '_AGENCIA = "col$causaciondiariamov".ID_AGENCIA and'
      
        '"col$causaciondiaria".ID_COLOCACION = "col$causaciondiariamov".I' +
        'D_COLOCACION)'
      'where "col$causaciondiaria".FECHA_CORTE = :FECHA'
      'order by "col$causaciondiaria".ID_COLOCACION ASC')
    Left = 600
    Top = 142
    ParamData = <
      item
  ...
  object ReporteD: TprTxReport
    ...
    object gEdad: TprGroup
      Valid = 'IBQuery1.EDAD_ACT'
      DetailBand = ReporteD.prTxHDetailBand1
    end
    object gClasifiacionT: TprGroup
      Valid = 'IBQuery1.ID_CLASIFICACION'
      DetailBand = ReporteD.prTxHDetailBand2
    end
    object gGarantiaT: TprGroup
      Valid = 'IBQuery1.ID_GARANTIA'
      DetailBand = ReporteD.prTxHDetailBand2
