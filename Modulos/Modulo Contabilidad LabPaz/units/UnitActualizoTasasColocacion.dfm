object frmActualizoTasas: TfrmActualizoTasas
  ...
  object DsetFija: TIBQuery
    ...
    Transaction = dmGeneral.IBTransaction1
    SQL.Strings = (
      'select *  from "col$tasafijas" order by ID_TASA_FIJA DESC')
    Left = 344
    Top = 100
    object DsetFijaID_TASA_FIJA: TIntegerField
      FieldName = 'ID_TASA_FIJA'
      Origin = '"col$tasafijas"."ID_TASA_FIJA"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object DsetFijaFECHA_INICIAL: TDateField
      FieldName = 'FECHA_INICIAL'
      Origin = '"col$tasafijas"."FECHA_INICIAL"'
    end
    object DsetFijaFECHA_FINAL: TDateField
      FieldName = 'FECHA_FINAL'
      Origin = '"col$tasafijas"."FECHA_FINAL"'
    end
    object DsetFijaVALOR_TASA_EFECTIVA: TFloatField
      FieldName = 'VALOR_TASA_EFECTIVA'
      Origin = '"col$tasafijas"."VALOR_TASA_EFECTIVA"'
    end
  end
