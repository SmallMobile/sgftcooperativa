...
uses
  ...
  IBSQL, IBDatabase, Math, pr_Common, pr_TxClasses, ComCtrls;
...
// Codigo Impuesto Asumido
             ...
             if (AR^.IdDest = 1) and (AR^.IdAgencia = Agencia) then begin
...
//                Comision := SimpleRoundTo((AR^.ComisBanco / ((100+Iva)/100)),0);
//                IvaComision := AR^.ComisBanco - Comision;
//                GMF := 0;
                Comision := 0;
                IvaComision := 0;
             end;
