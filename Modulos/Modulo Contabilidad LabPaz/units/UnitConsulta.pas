...
uses
  ...
  JvBaseDlg, JvNagScreen, OleCtrls, DPSDKOPSLib_TLB, DpSdkEngLib_TLB, ComObj,
...
begin
	...
	CadenaDatos.Add('    .Datos1{font-family: Arial; font-size: smaller; font-weight: 400; font-style: normal;}');
        ...
        try
          Navegador1.Navigate('C:\Datos.html');
{          Sleep(500);
          Rango := ((Navegador1.Document as IHTMLDocument2).body as
                    IHTMLBodyElement).createTextRange;
          Rango.collapse(False);
          Rango.pasteHTML(CadenaDatos.Text);
}
        finally
          CadenaDatos.Free;
        end;
...
procedure TfrmConsulta.FPGetTemplate1Done(Sender: TObject;
  var pTemplate: OleVariant);
var
...
//          m_data := VarArrayCreate([0,frmRegister.blobSize],varByte);
          m_data := VarArrayCreate([0,1023],varByte);
