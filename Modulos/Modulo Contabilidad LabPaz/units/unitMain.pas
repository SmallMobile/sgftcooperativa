...
type
  TfrmMain = class(TForm)
    ...
    ComprobantedeCierre2: TMenuItem;
    ExportarSaldosIniciales1: TMenuItem;
    ...
    procedure ComprobantedeCierre2Click(Sender: TObject);
    procedure ExportarSaldosIniciales1Click(Sender: TObject);
  private
...
uses unitLogin, IniFiles,
     ...
     UnitReLogin,
     UnitPaginarPapel,UnitConsolidarSaldoIAgencia,
     UnitLibroRMayorYBalance, UnitConsolidarCajaDiario, UnitLibroCajaDiario,
     UnitCajaDiario,UnitBalanceConsolidado,
     UnitEstadoIyGConsolidado, UnitCierreAnual, UnitExportarSaldos;
...
begin
  ...
  try
    ...
    DBCharSet := ReadString('DBNAME','charset','NONE');
          ...
          if frmLogin.ShowModal = mrOk then
           begin
             ...
             begin
                ...
                Role := EdRole.Text;
                dmGeneral.IBDatabase1.DataBaseName := DBpath + DBname;// DBserver + ':' + DBpath + DBname;
                dmGeneral.IBDatabase1.Params.Values['lc_ctype'] := DBCharSet;
...
begin
        Self.Caption := 'Módulo Contable Fundación Laboratorio de Paz III - ' + DBserver;
        if SalirMal then
           Self.Close;
end;
...
procedure TfrmMain.ComprobantedeCierre2Click(Sender: TObject);
var
...
procedure TfrmMain.ExportarSaldosIniciales1Click(Sender: TObject);
var
