...
begin
        ...
        begin
          ...
          if Todos.Checked then
           begin
             ...
             SQL.Add('and "cap$maestrotitular".TIPO_TITULAR =1');// and "cap$maestrotitular".NUMERO_TITULAR = 1');
           ...
           begin
             ...
             SQL.Add('and "cap$maestrotitular".TIPO_TITULAR =1');// and "cap$maestrotitular".NUMERO_TITULAR = 2');
             SQL.Add('order by "gen$detalles".FECHA_ENTREGA,"gen$detalles".HORA_ENTREGA');
             if RGTipo.ItemIndex = 0 then
               ParamByName('ID_TIPO_CAPTACION').AsInteger := 1
             else
           ...
           begin
             ...
             SQL.Add('"gen$detalles".ID_AGENCIA = :"ID_AGENCIA" and "gen$detalles".ID_TIPO_CAPTACION = :ID_TIPO_CAPTACION');
             SQL.Add('and "cap$maestrotitular".TIPO_TITULAR =1');// and "cap$maestrotitular".NUMERO_TITULAR = 2');
             SQL.Add('and "gen$detalles".ANO = :ANO');
             SQL.Add('order by "gen$detalles".FECHA_ENTREGA, "gen$detalles".HORA_ENTREGA');
             if RGTipo.ItemIndex = 0 then
               ParamByName('ID_TIPO_CAPTACION').AsInteger := 1
             else
 ...
 {         while not Eof do begin
        ...
        if RGTipo.ItemIndex = 0 THEN
           InformeDiario.Variables.ByName['Tipo'].AsString := 'ASOCIADOS'
        else
