object frmOperacionesAcumuladas: TfrmOperacionesAcumuladas
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "cap$maestrotitular".NUMERO_CUENTA, "gen$persona".ID_IDEN' +
        'TIFICACION,"gen$persona".ID_PERSONA,"gen$persona".PRIMER_APELLID' +
        'O,"gen$persona".SEGUNDO_APELLIDO,"gen$persona".NOMBRE, "caj$movi' +
        'miento".ID_TIPO_MOVIMIENTO, "caj$movimiento".BILLETES from "caj$' +
        'movimiento"'
        ...
        'where "caj$movimiento".FECHA_MOV BETWEEN :FECHA1 and :FECHA2 and' +
        ' "caj$movimiento".ID_TIPO_CAPTACION BETWEEN 1 and 6 and "cap$mae' +
        'strotitular".NUMERO_TITULAR = 1')
    Left = 36
    Top = 11
    ParamData = <
      item
