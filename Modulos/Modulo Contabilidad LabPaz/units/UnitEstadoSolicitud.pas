...
begin
        ...
        begin
          ...
          frmProgreso.Titulo := 'Solicitudes Aprobadas Ocaña: ' + IntToStr(RecordCount);
          ...
          begin
            ...
            begin
               ...
               CDaprobado.FieldValues['desc_agencia'] := 'OCAÑA';
...
//inicio de la verificación de las agencias
        solicitudagencia(3052,2,'192.168.201.2','ABREGO');
        solicitudagencia(3052,3,'192.168.202.2','CONVENCION');
