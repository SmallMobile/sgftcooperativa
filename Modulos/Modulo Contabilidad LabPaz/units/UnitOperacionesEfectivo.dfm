object frmOperacionesEfectivo: TfrmOperacionesEfectivo
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "caj$movimiento".FECHA_MOV,"cap$maestrotitular".ID_PERSON' +
        'A,"gen$persona".PRIMER_APELLIDO,"gen$persona".SEGUNDO_APELLIDO,"' +
        'gen$persona".NOMBRE,"caj$movimiento".ID_TIPO_CAPTACION,"caj$movi' +
        'miento".NUMERO_CUENTA, "caj$movimiento".ID_TIPO_MOVIMIENTO, "caj' +
        '$movimiento".DOCUMENTO, "caj$movimiento".BILLETES from "caj$movi' +
        'miento"'
      
        'left join "cap$maestrotitular" on ("caj$movimiento".ID_AGENCIA =' +
        ' "cap$maestrotitular".ID_AGENCIA) AND ("caj$movimiento".ID_TIPO_' +
        'CAPTACION = "cap$maestrotitular".ID_TIPO_CAPTACION) AND'
      
        '                                   ("caj$movimiento".NUMERO_CUEN' +
        'TA = "cap$maestrotitular".NUMERO_CUENTA) AND ("caj$movimiento".D' +
        'IGITO_CUENTA = "cap$maestrotitular".DIGITO_CUENTA)'
      
        'left join "gen$persona" on ("cap$maestrotitular".ID_IDENTIFICACI' +
        'ON = "gen$persona".ID_IDENTIFICACION) AND ("cap$maestrotitular".' +
        'ID_PERSONA = "gen$persona".ID_PERSONA)'
      
        'where "caj$movimiento".FECHA_MOV BETWEEN :FECHA1  and :FECHA2 an' +
        'd "caj$movimiento".BILLETES >= :VALOR and "caj$movimiento".ID_TI' +
        'PO_CAPTACION BETWEEN 1 and 6 and "cap$maestrotitular".NUMERO_TIT' +
        'ULAR = 1'
      'order by "caj$movimiento".FECHA_MOV')
    Left = 36
    Top = 17
    ParamData = <
      item
  ...
  object IBQuery2: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "caj$movimientocol".FECHA_MOV,"col$colocacion".ID_PERSONA' +
        ',"gen$persona".PRIMER_APELLIDO,"gen$persona".SEGUNDO_APELLIDO,"g' +
        'en$persona".NOMBRE,7 as ID_TIPO_CAPTACION,"caj$movimientocol".ID' +
        '_COLOCACION , 1 AS ID_TIPO_MOVIMIENTO, "caj$movimientocol".DOCUM' +
        'ENTO, "caj$movimientocol".BILLETES from "caj$movimientocol"'
        ...
        ' and "caj$movimientocol".BILLETES >= :VALOR'
      'order by FECHA_MOV')
    Left = 66
    Top = 18
    ParamData = <
