...
// Envio Parametros
        ...
        dmColocacion.IBDSlinea.Transaction.Commit;
end;
...
begin
    ...
    with dmColocacion do
     begin
       ...
       if IBDSlinea.Transaction.InTransaction then
         IBDSlinea.Transaction.Rollback;

       IBDSlinea.Transaction.StartTransaction;

       IBDSclasificacion.Close;
       IBDSclasificacion.Open;
