object FrmReporteEnte: TFrmReporteEnte
  ...
  object IBtotal_of: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "col$registroagencia"'
        ...
        '  INNER JOIN "col$garantia" ON ("col$registroagencia".GARANTIA =' +
  ...
  object IBtotal_of_h: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "col$registroagencia".ASOCIADO,'
      '  "col$registroagencia".VALOR_SOLICITUD,'
      '  "col$registrosesion".ID_ENTE_APROBADOR,'
      '  "col$registroagencia".GARANTIA,'
      '  "col$garantia".DESCRIPCION_GARANTIA,'
      '  "col$estadosolicitud".DESCRIPCION_ESTADO,'
      '  "col$registrosesion".ACTA,'
      ...
      '  "col$garantia"'
        ...
        '  INNER JOIN "col$registroagencia" ON ("col$garantia".ID_GARANTI' +
        'A = "col$registroagencia".GARANTIA)'
      
        '  INNER JOIN "col$registrosesion" ON ("col$registroagencia".ID_S' +
        'OLICITUD = "col$registrosesion".ID_SOLICITUD),'
      '  "col$estadosolicitud"'
      
        '  INNER JOIN "col$registrosesion" ON ("col$estadosolicitud".ID_E' +
        'STADO = "col$registrosesion".ESTADO)'
      
        '  INNER JOIN "gen$agencia" ON("col$registrosesion".ID_AGENCIA = ' +
        '"gen$agencia".ID_AGENCIA)'
      'WHERE'
      '  ("col$registrosesion".ID_AGENCIA <> 1)'
      '  AND ("col$registrosesion".id_ente_aprobador  = :ID_ENTE)'
      '  AND ("col$registrosesion".fecha = :FECHA)'
      '  AND ("col$registrosesion".HORA_INICIO = :HORA)'
      'order by "col$registrosesion".ID_AGENCIA')
    Left = 144
    Top = 96
    ParamData = <
      item
