...
var     aprobada,aplazada,negada,ratificada,anulada :Integer;
begin
        aplazada := 0;
        negada := 0;
        aprobada := 0;
        ...
        begin
           ...
           begin
             ...
             begin
               aprobada := aprobada + 1;
               aprobado := aprobado + FieldByName('VALOR_SOLICITUD').AsCurrency;
             end
             else if FieldByName('ESTADO').AsInteger = 15 then
                  anulada := anulada + 1
             else if FieldByName('ESTADO').AsInteger = 7 then
             ...
             begin
               ratificada := ratificada + 1;
               valor_ratificado := valor_ratificado + FieldByName('VALOR_SOLICITUD').AsCurrency;
             end;
             if FieldByName('GARANTIA').AsInteger = 1 then
             begin
                total_admisible := total_admisible + 1;
                valor_admisible := valor_admisible + FieldByName('VALOR_SOLICITUD').AsCurrency;
             end
             else if FieldByName('GARANTIA').AsInteger = 2 then
             begin
                total_noadmisible := total_noadmisible + 1;
                valor_noadmisible := valor_noadmisible + FieldByName('VALOR_SOLICITUD').AsCurrency;
             end;
                CDreporte.Append;
                CDreporte.FieldValues['garantia'] := FieldByName('DESCRIPCION_GARANTIA').AsString;
                CDreporte.FieldValues['nombres'] := FieldByName('ASOCIADO').AsString;
                CDreporte.FieldValues['valor'] := FieldByName('VALOR_SOLICITUD').AsCurrency;
                CDreporte.FieldValues['solicitud'] := FieldByName('ID_SOLICITUD').AsString;
                CDreporte.FieldValues['estado'] := FieldByName('DESCRIPCION_ESTADO').AsString;
