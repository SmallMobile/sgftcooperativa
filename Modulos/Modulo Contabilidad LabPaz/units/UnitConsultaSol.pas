...
type
  TFrmConsultaSol = class(TForm)
    ...
    CDsolicitudanalista: TStringField;
...
uses UnitDmSolicitud, UnitDescObservacion, UnitGlobales;
...
begin
        ...
        begin
          ...
          SQL.Add('LEFT OUTER JOIN "gen$empleado" ON ("col$solicitud".ID_ANALISIS = "gen$empleado".ID_EMPLEADO)');
          SQL.Add('WHERE');
          ...
          begin
            ...
            CDsolicitud.FieldValues['analista'] := FieldByName('NOMBRE').AsString + ' ' + FieldByName('PRIMER_APELLIDO').AsString;
...
begin
        ...
        begin
          ...
          ExecQuery;
          vEmpleado := FieldByName('NOMBRE').AsString + ' ' + FieldByName('PRIMER_APELLIDO').AsString;
          Close;
          SQL.Clear;
          SQL.Add('SELECT');
          SQL.Add('"col$estadosolicitud".DESCRIPCION_ESTADO,');
          ...
          begin
            ...
            CDsolicitud.FieldValues['fecha'] := FieldByName('FECHA_RECEPCION').AsDateTime;
            CDsolicitud.FieldValues['cod_estado'] := FieldByName('ID_ESTADO').AsInteger;
            CDsolicitud.FieldValues['empleado'] := vEmpleado;
            CDsolicitud.Post;
            Close;
            SQL.Clear;
            SQL.Add('select PRIMER_APELLIDO,SEGUNDO_APELLIDO,NOMBRE from "gen$persona"');
...
begin
        ...
        begin
          ...
          if RecordCount <> 0 then
          begin }
        //if CDsolicitudcod_estado.Value in [1,13] then
//        begin
             FrmDescObsrevacion := TFrmDescObsrevacion.Create(Self);
             FrmDescObsrevacion.Caption := 'Observaciones. Solicitud No. ' + CDsolicitudradicado.Text ;
             FrmDescObsrevacion.Mobservacion.Text := CDsolicitudobservacion.Text;//FieldByName('OBSERVACION').AsString;
