...
//           SQL.Add('SELECT * FROM P_CAP_0008_JUD (:ID_AGENCIA,:ID_TIPO_CAPTACION,:ID_IDENTIFICACION,:ID_PERSONA)');
           SQL.Add('SELECT P_CAP_0008_JUD.NUMERO_CUENTA, P_CAP_0008_JUD.DIGITO_CUENTA, P_CAP_0008_JUD.ID_ESTADO');
...
begin
        ...
        begin
           ...
           SQL.Add(':ID_IDENTIFICACION,:ID_PERSONA,:CONSECUTIVO,:ID_DIRECCION,:DIRECCION,:BARRIO,:MUNICIPIO,:TELEFONO1,:TELEFONO2,:TELEFONO3,:TELEFONO4)');
           ParamByName('ID_PERSONA').AsString := JvDocumento.Text;
           ParamByName('ID_IDENTIFICACION').AsInteger := DBidentificacion.KeyValue;
...
//           SQL.Add('WHERE ID_PERSONA = :ID_PERSONA AND ID_IDENTIFICACION = :ID_IDENTIFICACION');
           ...
           begin
             ...
             begin
               ...
               if DmSolicitud.IBSolicitud1.FieldByName('ENTIDAD').AsString = 'CREDISERVIR LTDA (F)' then
