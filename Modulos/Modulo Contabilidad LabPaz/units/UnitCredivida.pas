...
begin
        ...
        with Nodo do
        begin
          WriteString('cedula',id_persona);
          WriteString('nombre',JVnombres.Caption);
          ...
          begin
            ...
            if RecordCount = 0 then
            begin
               WriteString('nom1','LOS DE LEY 100%');
...
begin
      ...
      begin
        ...
        Vtotal := SimpleRoundTo(valor_credivida + ((valor_credivida /1000)*4),0);
      end
      else
      begin
      ...
      try
        ...
        begin
         ...
         begin
            ...
            auxiliar('244295000000000000','',0,0,((valor_credivida/1000)*4),False);
...
procedure TFrmCredivida.auxiliar(Vcodigo, Vid_persona: string; Vcuenta,
  Vid_identificacion: integer; Vvalor: Currency;Vtipo:Boolean);
begin
            with DmSolicitud.IBSolicitud1 do
            begin
...
begin
        ...
        begin
          ...
          Close;
          SQL.Clear;
          SQL.Add('insert into "col$credivida" values (:NUMERO_CUENTA,:DG_CUENTA,:FECHA_VENCIMIENTO,0,0,NULL,NULL,0,NULL)');
          ParamByName('NUMERO_CUENTA').AsInteger := id_cuenta;
