...
begin
        ...
        if ingresos <> -1 then begin
          ...
          begin
            ...
            SQL.Add('"col$solicitud".INVERSION = :INVERSION, "col$solicitud".CLASIFICACION = :CLASIFICACION, "col$solicitud".FECHA_ANALISIS = :FECHA_ANALISIS,"col$solicitud".VALOR_APROBADO = :VALOR_APROBADO,"col$solicitud".PLAZO_APROBADO = :PLAZO_APROBADO');
            SQL.Add('where ID_SOLICITUD = :ID_SOLICITUD');
            ParamByName('ID_SOLICITUD').AsString := MKsolicitud.Text;
