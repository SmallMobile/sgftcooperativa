...
uses
  ...
  IBQuery, FR_Class, FR_DSet, FR_DBSet, DBClient, frexpimg,sdXmlDocuments, JclFileUtils;
...
type
  TfrmMain = class(TForm)
    ...
    N7: TMenuItem;
    arjetasconEstado1: TMenuItem;
    N8: TMenuItem;
    MovimientosdelDa1: TMenuItem;
    SaldosenCuentas1: TMenuItem;
    N9: TMenuItem;
    ...
    procedure SaldosenCuentas1Click(Sender: TObject);
...
uses unitLogin, unitdmColocacion, IniFiles,
     ...
     UnitInformeAuxiliar, UnitInformeDiarioCaja,UnitInformeTarjetasEntregadas,
     UnitInformeTarjetasCanceladas, UnitInformeTarjetasBloqueadas,
     UnitInformeMovDia, UnitPedidoPlasticosGlobal, UnitSaldosCuentasconTarjetaDebito,
     UnitInformePlasticos, UnitListadoGeneralCaptaciones;
...
procedure TfrmMain.SaldosenCuentas1Click(Sender: TObject);
var
