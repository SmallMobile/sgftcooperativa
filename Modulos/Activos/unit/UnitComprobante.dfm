object FrmComprobantes: TFrmComprobantes
  ...
  object Panel1: TPanel
    ...
    object comboagencia: TComboBox
      ...
      ItemHeight = 13
      TabOrder = 0
      OnExit = comboagenciaExit
      OnKeyPress = comboagenciaKeyPress
    end
    object tipo_comp1: TEdit
      Left = 85
      Top = 42
      Width = 121
      Height = 21
          ...
          dRec.Versions = <
            item
              ...
              Memo.Strings = (
                  ...
                  'Fecha: [:<dd/mm/yyyy>QueryComprobante.FECHADIA] Agencia : [ofici' +
                  'na]')
        ...
        object prTxMemoObj6: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                'Fecha de Impresion : [:<dd/mm/yyyy>StartDateTime]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
