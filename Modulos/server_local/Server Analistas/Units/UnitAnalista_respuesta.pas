...
uses
  ...
  IBQuery, DBXpress, SqlExpr, FMTBcd, DateUtils;
...
var     IBconsulta,IBextracto :TSQLQuery;
        ...
        tamano :Integer;
        nodo,nodo1,Nobservacion :TXmlNode;
        id_solicitud :string;
        id_tipo :string;
        id_modulo :string;
...
begin
        ...
        IBconsulta.SQLConnection := SQLConnection1;
        IBextracto.SQLConnection := SQLConnection1;
        SQLConnection1.Open;
        IBTconsulta.TransactionID := 1;
        IBTconsulta.IsolationLevel := xilREADCOMMITTED;
        SQLConnection1.StartTransaction(IBTconsulta);
        ...
        id_modulo := XmlRes.Root.ReadString('id_modulo');// A ANALISIS E ENTE APROBADOR
       try
         ...
         begin
          ...
          begin
            ...
            begin
              ...
              nodo.WriteFloat('disponibilida',FieldByName('DISPONIBILIDAD').AsFloat);
              ...
              begin
                ...
                nodo1.WriteString('disp_pago',FieldByName('DISP_PAGO').AsString);
         ...
         begin
           ...
           begin
             ...
             SQLConnection1.Commit(IBTconsulta);
     except
      on E: Exception do
      begin
        XmlRes.Clear;
        ...
        SQLConnection1.Rollback(IBTconsulta);
      end;// fin del on
      end;// fin del try
      MyList.Clear;
      //Dispose(ARecord);
...
begin
     ...
     //SQLConnection1.Params.Append('Database='+DBServer+':'+DBPath+DBName);
     ...
     SQLConnection1.Params.Append('Database='+DBServer+':'+DBPath+DBName);
     SQLConnection1.Params.Append('RoleName=REMOTE');
     SQLConnection1.Params.Append('User_Name=REMOTEQUERY');
     SQLConnection1.Params.Append('Password=remoterestore');
     SQLConnection1.Params.Append('ServerCharSet=ISO8859_1');
     SQLConnection1.Params.Append('SQLDialect=3');
     IdTCPServer1.Active := True;
     SQLConnection1.Connected := True;
     Memo1.Text := SQLConnection1.Params.Values['Database'];
end;

procedure TFrmServer_Analistas.extracto;
begin

end;

procedure TFrmServer_Analistas.Button1Click(Sender: TObject);
begin
SQLConnection1.Params.Append('Database='+DBServer+':'+DBPath+DBName);
end;
