...
begin
      ...
      with IBSQL1 do
       begin
         ...
         SQL.Add('("cap$maestro".ID_ESTADO IN (1,3,4,6,12,13,14)))');
         ...
         while not Eof do
          begin
            ...
            AR^.Municipio := '12'; //IntToStr(IBAgencia.FieldByName('CODIGO_MUNICIPIO').AsInteger);
            AR^.Correo := 'n@a';
       ...
       begin
         ...
         while not Eof do
          begin
            ...
            AR^.Activo := '0';
            AR^.Ciiu := StringReplace(Format('%4s',[trim(FieldByName('ID_CIIU').AsString)]),' ','0',[rfReplaceAll]);
            AR^.Municipio := IntToStr(IBAgencia.FieldByName('CODIGO_MUNICIPIO').AsInteger);
            AR^.Correo := 'n@a';
