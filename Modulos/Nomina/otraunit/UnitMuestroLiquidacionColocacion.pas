...
uses UnitdmColocacion, UnitVistaPreliminar,
     UnitGlobalesCol, UnitGlobales,unitdata;
...
///**Genero el consecutivo
    ...
    with IBQuery do
     try
      ...
      DescImpuesto := SimpleRoundTo((TotalLiquidacion/1000) * 4,0);
      New(AR);
      AR^.CuotaNumero := 0;
       ...
       begin
         ...
         if Total > 0 then
          begin
            ...
            ParamByName('VALOR_CREDITO').AsCurrency := Total;
            try
              Open;
...
begin
        ...
        with IBQuery1 do
         begin
          ...
          sql.Add('order by FECHA_EXTRACTO');
          Parambyname('ID_AGENCIA').AsInteger := agencia;
          parambyname('ID_COLOCACION').AsString := colocacion;
          open;
          First;
