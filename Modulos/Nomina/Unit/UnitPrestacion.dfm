object FrmPrestacion: TFrmPrestacion
  Left = 261
  Top = 217
  Width = 324
  Height = 231
  BorderIcons = []
  Caption = 'Registrar Servicio'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object dbservicio: TDBLookupComboBox
      Left = 106
      Top = 55
      Width = 177
      Height = 21
      KeyField = 'codigo'
      ListField = 'descripcion'
      ListSource = DSservicio
      TabOrder = 1
      OnExit = dbservicioExit
      OnKeyPress = dbservicioKeyPress
    end
  ...
  object IBservicio: TIBQuery
    Database = DataGeneral.IBDatabase1
    Transaction = IBTransempresa
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from  "nom$tipoprestacion"')
    Left = 80
  end
