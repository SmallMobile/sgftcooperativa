object FrmRepCartera: TFrmRepCartera
  Left = 236
  Top = 316
  Width = 434
  Height = 151
  BorderIcons = [biSystemMenu]
  Caption = 'Reportes de Cartera'
  Color = clBtnFace
  ...
  object l: TPanel
    ...
    object nomina: TDBLookupComboBox
      Left = 140
      Top = 34
      Width = 187
      Height = 21
  ...
  object IBtiponomina: TIBQuery
    ...
    SQL.Strings = (
      ...
      '/*where'
      '"nom$tiponomina"."codigo" in (10,20)*/')
    Left = 32
  end
  ...
  object IBQuery1: TIBQuery
    ...
    SQL.Strings = (
      ...
      'from "col$extractodet"'
        ...
        'left join "col$colocacion" on ("col$extractodet".ID_COLOCACION =' +
      ...
      '"col$extractodet".ID_AGENCIA = "con$puc".ID_AGENCIA )'
        ...
        'inner join "col$extracto" on ("col$extractodet".ID_CBTE_COLOCACI' +
        'ON = "col$extracto".ID_CBTE_COLOCACION and "col$extractodet".FEC' +
        'HA_EXTRACTO = "col$extracto".FECHA_EXTRACTO)'
      'where'
      
        '("col$extractodet".ID_CBTE_COLOCACION >= :"ID1" and "col$extract' +
        'odet".ID_CBTE_COLOCACION <= :"ID2") and'
      '"col$extracto".FECHA_EXTRACTO = :"FECHA_EXTRACTO"'
      
        'order by "col$extractodet".ID_CBTE_COLOCACION,  "col$extractodet' +
        '".VALOR_CREDITO'
      '')
    Left = 64
    Top = 24
