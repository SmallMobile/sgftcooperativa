object FrmCausacion: TFrmCausacion
  Left = 390
  Top = 219
  Width = 434
  Height = 153
  BorderIcons = [biSystemMenu]
  Caption = 'Causacion de Obligaciones Laborales'
  Color = clBtnFace
  ...
  object IBValor: TIBQuery
    Database = DataGeneral.IBDatabase1
    Transaction = IBTransaction6
    SQL.Strings = (
      'SELECT'
      
        'sum("nom$nomina"."sueldobasico")/count("nom$nomina"."sueldobasic' +
        'o") as promedio'
      'FROM'
      ' "nom$nomina"'
      
        ' INNER JOIN "nom$controlnomina" ON ("nom$nomina"."codigo_nomina"' +
        '="nom$controlnomina"."cod_nomina")'
      'WHERE'
      '  ("nom$controlnomina"."fecha" >= :FECHA) AND'
      '  ("nom$nomina"."nit_empleado" = :ID)')
    Left = 120
    Top = 16
    ParamData = <
      item
