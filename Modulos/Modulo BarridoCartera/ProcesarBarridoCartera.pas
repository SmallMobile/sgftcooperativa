...
var
  MiIni:TIniFile;
begin
  MiIni := TIniFile.Create('./BarridoCartera.ini');
...
{        with IBQTabla do
         begin
           Close;
           SQL.Clear;
           SQL.Add('SELECT * FROM "col$controlbarrido" WHERE FECHA = :FECHA');
       ...
       if DayOf(FechaHoy) = (DaysInAMonth(YearOf(FechaHoy),MonthOf(FechaHoy))) then
        begin
          Self.Close;
          Exit;
        end;
...
begin
        ...
        Label1.Caption := 'Efectuando Liquidaciones';
        Bar1.Min := 0;
        Bar1.Max := Total;
        Bar1.Position := 0;
