...
type
  ...
  private
    ...
    FPriority: Integer;
    FExit_Code: LongWord; //process exit code
    procedure FExecute;
  protected
  ...
  published
    property Exit_Code : LongWord read FExit_Code;
  end;
 ...
 //spawn the child process
  ...
  try
    repeat //main program loop
      GetExitCodeProcess(pi.hProcess, FExit_Code); //while the process is running
    ...
    until ((FExit_Code <> STILL_ACTIVE) //process terminated (normally)
