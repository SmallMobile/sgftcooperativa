...
function ObtenerDeudaHoy(Agencia:Integer;Colocacion:string) : Currency;
...
begin
  ...
  with dmColocacion.IBSQL do
   begin
     Close;
     //verificatransaccion(dmColocacion.IBSQL);
     SQL.Clear;
  ...
  with dmColocacion.IBSQLcodigos do
   begin
     Close;
     //verifica(dmColocacion.IBSQLcodigos);
     SQL.Clear;
...
//         if MonthOf(Fecha1) = 2 then
  //        begin
    //        if Fecha1 = RecodeDay(Fecha1,Dayof(EndOfAMonth(YearOf(Fecha1),MonthOf(Fecha1)))) then
      //         FechaArranque := Fecha1;
        //  end
//         else
