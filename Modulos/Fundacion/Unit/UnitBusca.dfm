object FrmBuscar: TFrmBuscar
  ...
  Caption = 'Buscar y Actualizar Datos'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cbusqueda: TComboBox
      ...
      ItemHeight = 13
      TabOrder = 0
      OnExit = cbusquedaExit
      Items.Strings = (
        'DOCUMENTO'
        'NOMBRES')
    end
    object TEfiltro: TEdit
      Left = 312
      Top = 26
      Width = 241
      Height = 21
  ...
  object Panel2: TPanel
    ...
    object Mfecha: TMaskEdit
      Left = 424
      Top = 58
      Width = 123
      Height = 21
      Hint = 'Formato Fecha '#39'A'#241'o/Mes/Dia'#39
  ...
  object Panel5: TPanel
    ...
    object Label13: TLabel
      ...
      Width = 114
      Height = 13
      Caption = 'Relacion Programas'
    end
    object DBprograma: TDBGrid
      Left = 8
      Top = 22
      Width = 433
      Height = 93
      Hint = 
        'Para ver Una Relacion Completa de la Afiliacion Haga Doble Click' +
        ' sobre el Programa'
  ...
  object CDprograma: TClientDataSet
    Active = True
    Aggregates = <>
    FieldDefs = <
      item
    ...
    Top = 136
    Data = {
      
      0000000008636F6E76656E696F04000100000000000000}
    object CDprogramaprograma: TStringField
      FieldName = 'programa'
      Size = 100
    end
    object CDprogramafecha: TStringField
      FieldName = 'fecha'
      Size = 15
    end
    object CDprogramanit_asociado: TStringField
      FieldName = 'nit_asociado'
      Size = 15
    end
    object CDprogramafecha_a: TDateField
      FieldName = 'fecha_a'
    end
    object CDprogramaconvenio: TIntegerField
      FieldName = 'convenio'
    end
  end
  ...
  object report1: TprTxReport
    ...
    Values = <
      ...
      item
        ...
        Name = 'depremen'
        AggFunction = prafSum
        Formula = 'depreciacion.depreciacion_mes'
        ResetOn = rvtGroup
        CalcOn = cvtDataSetNext
        DataSetName = 'depreciacion'
      end>
