...
procedure TForm1.procesar(tipo: integer; id: string);
var
  i,j,k,l:Integer;
...
function TForm1.BuscoTasaAnt(Ag: Integer;Colocacion: string;FechaIntereses:TDate): Single;
begin
...
function TForm1.FldToStr(const Value : TFieldType) : String;
begin
   Case Value of
