...
begin
        ...
        edColocacion.Enabled := false;
          ...
          ShowMessage('Colocación No Encontrada o Fecha de Corte Incorrecta. Verifique');
end;
...
begin
        ...
        begin
         ...
         begin
           ...
           ShowMessage('Evaluación no Valida. Verifique');
        end;
          ...
          begin
            ...
            if diferencia <> 0 then
             ...
             begin
              ...
              ParamByName('ID_AGENCIA').AsInteger:= Agencia;
              ParamByName('FECHA').AsDate := edFechaComprobante.Date;
              ParamByName('CODIGO').AsString := '511515000000000000';
            ...
            ShowMessage('Evaluación Aplicada con Exito!!');
          end
          else
          begin
              IBTransaction1.Rollback;
              ShowMessage('Error al Aplicar Evaluación');
          end;
...
begin
        ...
        begin
           ...
           ShowMessage('Valor no Válido. Verifique');
end;
