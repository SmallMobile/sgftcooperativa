...
namespace sConsulta
{
	public class Program
	{
		...
		public static void Main()
		{
		    ...
		    CreateLogFiles.ErrorLog(globalvars.Logfile,"Iniciando Servicio...puerto:"+Convert.ToString(globalvars.port));
			...
			{
				CreateLogFiles.ErrorLog(globalvars.Logfile,e.Message);
			}
			CreateLogFiles.ErrorLog(globalvars.Logfile,"cerrando servicio...");
		}
