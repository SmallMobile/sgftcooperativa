...
type
  TfrmLibroMayorYBalance = class(TForm)
    ...
    procedure ReportBalanceUnknownVariable(Sender: TObject;
...
procedure TfrmLibroMayorYBalance.ReportBalanceUnknownVariable(
  Sender: TObject; const VarName: String; var Value: TprVarValue;
  var IsProcessed: Boolean);
var Saldo:Currency;
begin
{        if VarName = 'TotalDebitoActual' then
        begin
             with IBQTabla1 do begin
        end;
}
end;
