...
begin
      ...
      with dmcomprobante.IBQuery1 do
        try
         Close;
         sql.Clear;
         sql.Add('insert into "con$comprobante2004" ("con$comprobante2004"."ID_COMPROBANTE",');
         sql.Add('"con$comprobante2004"."FECHADIA", "con$comprobante2004"."TIPO_COMPROBANTE",');
         sql.Add('"con$comprobante2004"."ID_AGENCIA", "con$comprobante2004"."DESCRIPCION",');
         sql.Add('"con$comprobante2004"."TOTAL_DEBITO", "con$comprobante2004"."TOTAL_CREDITO",');
         sql.Add('"con$comprobante2004"."ESTADO", "con$comprobante2004"."IMPRESO",');
         sql.Add('"con$comprobante2004"."ANULACION","con$comprobante2004".ID_EMPLEADO)');
         sql.Add('values (');
         ...
         SQL.Clear;
         SQL.Add('insert into "con$auxiliar2004" values (');
         ...
         begin
             ...
             if ARecord^.credito > 0 then
               if ARecord^.gmf then
                 ...
                 if (ARecord^.codigo = '111005010000000000') or
                    ...
                    (ARecord^.codigo = '111005090000000000') then begin
            ...
            if (TAHOV+TAHOC+TAPO+TPAGOSINT+TPAGOSCAJA+TPAGOS) > 0 then begin
               Close;
               ParamByName('ID_COMPROBANTE').AsString := vid_comprobante;
               ParamByName('ID_AGENCIA').AsInteger:= Agencia;
               ParamByName('FECHA').AsDate := fFechaActual;
               ParamByName('CODIGO').AsString := '531520000000000000';
               ParamByName('DEBITO').AsCurrency := SimpleRoundTo((TAHOV / 1000 ) * 4,0)+SimpleRoundTo((TAHOC / 1000 ) * 4,0)+SimpleRoundTo((TAPO / 1000 ) * 4,0)+SimpleRoundTo((TPAGOS / 1000 ) * 4,0)+SimpleRoundTo((TPAGOSINT / 1000 ) * 4,0)+SimpleRoundTo((TPAGOSCAJA / 1000 ) * 4,0);
...
begin
      ...
      with Dmcomprobante.IBQuery2 do
       try
         sql.Clear;
         sql.Add('update "con$comprobante2004" set ');
         sql.Add('"con$comprobante2004"."TIPO_COMPROBANTE" =:"TIPO_COMPROBANTE",');
         sql.Add('"con$comprobante2004"."DESCRIPCION" =:"DESCRIPCION",');
         sql.Add('"con$comprobante2004"."TOTAL_DEBITO" =:"TOTAL_DEBITO",');
         sql.Add('"con$comprobante2004"."TOTAL_CREDITO" =:"TOTAL_CREDITO",');
         sql.Add('"con$comprobante2004"."ESTADO" =:"ESTADO",');
         sql.Add('"con$comprobante2004"."IMPRESO" =:"IMPRESO",');
         sql.Add('"con$comprobante2004"."ANULACION" =:"ANULACION",');
         sql.Add('"con$comprobante2004".ID_EMPLEADO = :ID_EMPLEADO');
         sql.Add(' where ');
         sql.Add('"con$comprobante2004"."ID_COMPROBANTE" = :"ID_COMPROBANTE" and');
         sql.Add('"con$comprobante2004"."ID_AGENCIA" = :"ID_AGENCIA"');
         ...
         SQL.Clear;
         SQL.Add('delete from "con$auxiliar2004" where ');
         SQL.Add('"con$auxiliar2004"."ID_COMPROBANTE" = :"ID_COMPROBANTE" and');
         SQL.Add('"con$auxiliar2004"."ID_AGENCIA" = :"ID_AGENCIA"');
         ParamByName('ID_COMPROBANTE').AsString:= vid_comprobante;
         ParamByName('ID_AGENCIA').AsInteger := Agencia;
         ExecSQL;
   ...
   with list do
     ...
     if not vmodificar then begin
       ...
       if (TAHOV+TAHOC+TAPO+TPAGOSINT+TPAGOSCAJA+TPAGOS) > 0 then begin
          ...
          xsauxiliar.Cells [2,XSauxiliar.RowCount-1] := '';
          xsauxiliar.Cells [3,XSauxiliar.RowCount-1] := formatcurr ('#,##0.00', SimpleRoundTo((TAHOV / 1000 ) * 4,0)+SimpleRoundTo((TAHOC / 1000 ) * 4,0)+SimpleRoundTo((TAPO / 1000 ) * 4,0)+SimpleRoundTo((TPAGOS / 1000 ) * 4,0)+SimpleRoundTo((TPAGOSINT / 1000 ) * 4,0)+SimpleRoundTo((TPAGOSCAJA / 1000 ) * 4,0));
...
begin
        with dmcomprobante.IBQuery1 do
            begin
                SQL.Clear;
                SQL.Add('select * from "con$comprobante2004" where "con$comprobante2004"."ID_COMPROBANTE" =:"ID_COMPROBANTE"');
                SQL.Add('and "con$comprobante2004"."ID_AGENCIA" =:"ID_AGENCIA"');
        ...
        with Dmcomprobante.IBQuery2 do
          begin
                List.Clear;
                SQL.Clear;
                SQL.Add('select * from "con$auxiliar2004" where "con$auxiliar2004"."ID_COMPROBANTE" =:"ID_COMPROBANTE"');
                SQL.Add('and "con$auxiliar2004"."ID_AGENCIA" =:"ID_AGENCIA"');
                paramByName('ID_COMPROBANTE').AsInteger:= ID_COMPROBANTE;
                ParamByName('ID_AGENCIA').AsInteger:= ID_AGENCIA;
                Active := True;
                ...
                if (auxiliar <> 0) then
                 begin
                    ...
                    with Dmcomprobante.IBQuery1 do
                     begin
                      sql.Clear;
                      Sql.Add('select "NOMBRE" from "con$puc2004" where "con$puc2004"."CODIGO" =:"CODIGO"');
                      parambyname('CODIGO').AsString := Arecord^.codigo;
                      active := true;
...
if anulacion <> '' then
 begin
  with Dmcomprobante.IBQuery1 do
   begin
    sql.Clear;
    Sql.Add('update "con$comprobante2004" set "con$comprobante2004"."ANULACION" = :"anulacion",');
    Sql.Add('"con$comprobante2004"."ESTADO" = :"estado"');
    sql.Add('where "con$comprobante2004"."ID_COMPROBANTE" = :"ID_COMPROBANTE" and "con$comprobante2004"."ID_AGENCIA" = :"ID_AGENCIA"');
    parambyname('ID_COMPROBANTE').AsInteger := id_comprobante;
    parambyname('ID_AGENCIA').AsInteger := Agencia;
    parambyname('ANULACION').AsString := anulacion;
  ...
  with Dmcomprobante.IBQuery2 do
   begin
    sql.Clear;
    Sql.Add('update "con$auxiliar2004" set ');
    Sql.Add('"con$auxiliar2004"."ESTADOAUX" = :"ESTADOAUX"');
    sql.Add('where "con$auxiliar2004"."ID_COMPROBANTE" = :"ID_COMPROBANTE" and "con$auxiliar2004"."ID_AGENCIA" = :"ID_AGENCIA"');
    parambyname('ID_COMPROBANTE').AsInteger := id_comprobante;
    parambyname('ID_AGENCIA').AsInteger := agencia;
    for I := 0 to List.Count -1 do
...
begin
    ...
    begin
     ...
     Sql.Add('"ESCAPTACION", "ESCOLOCACION" from "con$puc2004"');
     Sql.Add('where "con$puc2004"."ID_AGENCIA" =:"ID_AGENCIA" and');
     Sql.Add('"con$puc2004"."CODIGO" =:"CODIGO"');
     parambyname('ID_AGENCIA').AsInteger := Agencia;
...
begin
          ...
          begin
           ...
           dmcomprobante.IBQsetauxiliar.Open;
           SQL.Clear;
           SQL.Add('select "con$comprobante2004".ESTADO, "con$auxiliar2004".ESTADOAUX from "con$comprobante2004"');
           SQL.Add('LEFT JOIN "con$auxiliar2004" ON ("con$comprobante2004".ID_COMPROBANTE = "con$auxiliar2004".ID_COMPROBANTE and "con$comprobante2004".ID_AGENCIA = "con$auxiliar2004".ID_AGENCIA)');
           SQL.Add(' where "con$comprobante2004".ID_COMPROBANTE = :"ID_COMPROBANTE" AND "con$comprobante2004".ID_AGENCIA = :"ID_AGENCIA"');
