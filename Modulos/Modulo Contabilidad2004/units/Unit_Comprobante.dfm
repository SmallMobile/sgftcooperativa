object frmComprobante: TfrmComprobante
  ...
  object QueryComprobante: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  "con$comprobante2004".IMPRESO,'
      '  "con$comprobante2004".ANULACION,'
      '  "con$tipocomprobante2004".DESCRIPCION AS DESCRIPCION1,'
  ...
  object QueryAuxiliar: TIBQuery
    ...
    SQL.Strings = (
      'select'
      '"con$auxiliar2004".ID_COMPROBANTE,'
      '"con$auxiliar2004".ID_AGENCIA,'
      ...
      'FROM "con$auxiliar2004" INNER JOIN "con$puc2004"'
      'ON ("con$auxiliar2004"."CODIGO" = "con$puc2004"."CODIGO")')
    Left = 58
    Top = 347
  ...
  object IBAuxiliar: TIBQuery
    ...
    SQL.Strings = (
      ...
      '         "gen$empleado".NOMBRE,'
      '         "con$auxiliar2004".CODIGO,'
      '         "con$puc2004".NOMBRE AS CUENTA,'
      '         "con$auxiliar2004".ID_CUENTA,'
      '         "con$auxiliar2004".ID_COLOCACION,'
      '         "con$auxiliar2004".ID_IDENTIFICACION,'
      '         "con$auxiliar2004".ID_PERSONA,'
      '         "gen$persona2004".PRIMER_APELLIDO AS PRIMER_APELLIDO1,'
      
        '         "gen$persona2004".SEGUNDO_APELLIDO AS SEGUNDO_APELLIDO1' +
        ','
      ...
      '"con$comprobante2004"'
        ...
        'LEFT JOIN "con$auxiliar2004" ON ("con$comprobante2004".ID_COMPRO' +
        'BANTE = "con$auxiliar2004".ID_COMPROBANTE)'
      
        'LEFT JOIN "con$tipocomprobante" ON ("con$comprobante2004".TIPO_C' +
        'OMPROBANTE  = "con$tipocomprobante".ID ) '
      
        'LEFT JOIN "gen$agencia" ON ("con$auxiliar2004".ID_AGENCIA = "gen' +
        '$agencia".ID_AGENCIA)'
      
        'LEFT JOIN "con$puc2004" ON ("con$auxiliar2004".CODIGO = "con$puc' +
        '2004".CODIGO)'
      
        'LEFT JOIN "gen$empleado" ON ("con$comprobante2004".ID_EMPLEADO =' +
        ' "gen$empleado".ID_EMPLEADO) '
      
        'LEFT JOIN "gen$persona" ON ("con$auxiliar2004".ID_IDENTIFICACION' +
        ' = "gen$persona".ID_IDENTIFICACION and "con$auxiliar2004".ID_PER' +
        'SONA = "gen$persona".ID_PERSONA )'
      'where ("con$comprobante2004".ID_AGENCIA = :"ID_AGENCIA" ) and'
      
        '           ("con$comprobante2004".ID_COMPROBANTE = :"ID_COMPROBA' +
        'NTE" )'
      'Order By  "con$auxiliar2004".CODIGO ASC')
    Left = 112
    Top = 348
    ParamData = <
      item
