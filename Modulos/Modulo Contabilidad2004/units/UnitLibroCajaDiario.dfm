object frmLibroRCajaDiario: TfrmLibroRCajaDiario
  ...
  object IBQTemp: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select "con$cajadiario".DIA,"con$cajadiario".CODIGO, "con$puc".N' +
        'OMBRE, SUM("con$cajadiario".DEBITO) AS DEBITO, SUM("con$cajadiar' +
        'io".CREDITO) AS CREDITO'
      'from "con$cajadiario"'
      ...
      'group by'
      '"con$cajadiario".DIA,"con$cajadiario".CODIGO,"con$puc".NOMBRE'
      'order by "con$cajadiario".DIA ASC, "con$cajadiario".CODIGO ASC')
    Left = 4
    Top = 24
    ParamData = <
      item
