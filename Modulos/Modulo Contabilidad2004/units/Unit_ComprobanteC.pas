...
uses UnitdmGeneral, digitacuentaC, UnitVistaPreliminar,
...
begin
          ...
          begin
           ...
           dmcomprobante.IBQsetauxiliar.Open;
           SQL.Clear;
           SQL.Add('select "con$comprobante".ESTADO, "con$auxiliar2004".ESTADOAUX from "con$comprobante"');
           SQL.Add('LEFT JOIN "con$auxiliar2004" ON ("con$comprobante".ID_COMPROBANTE = "con$auxiliar2004".ID_COMPROBANTE and "con$comprobante".ID_AGENCIA = "con$auxiliar2004".ID_AGENCIA)');
