...
uses
  ...
  FR_DBSet, ComCtrls, DateUtils, XMLIntf, XMLDoc, IdHTTP, IdGlobal, IdCoderMIME, UnitProgreso,
  IBSQL;
      ...
      begin
        ...
        if (cadena <> '') then begin
          ...
          try
             ...
             begin
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'estado') then
              begin
                  estado := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'documento') then
              begin
                  identificacion.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'nombre') then
              begin
                  nombre.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'numeroCuenta') then
              begin
                  cuenta.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'valorAprobado') then
              begin
                valor_a := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
                Valor.Caption := '$'+FormatCurr('#,##0.00',valor_a);
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'plazoAprobado') then
              begin
                  plazo.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'fechaRecepcion') then
              begin
                  fecha.Caption := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              if (XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].LocalName = 'tasaAprobada') then
              begin
                  tasaf := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
              else
              ...
              begin
                  ente := XMLResult.ChildNodes.Nodes['solicitud'].ChildNodes[i].NodeValue;
              end
