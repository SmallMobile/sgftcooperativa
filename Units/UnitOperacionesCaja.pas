...
uses
  ...
  IdComponent, IdTCPConnection, IdTCPClient, JclSysUtils, Math, IBDatabase,JPEG, DateUtil,
  RxCalc, ToolEdit, CurrEdit, DPFPDevXLib_TLB, DPFPEngXLib_TLB, DPFPShrXLib_TLB,
   UnitPantallaProgreso,xmldom, XMLIntf, msxmldom, XMLDoc, IdHTTP, IdCoder,
  IdCoder3to4, IdCoderMIME, IdGlobal;
...
uses UnitRelacionCheques,UnitArqueoDevolucion, UnitGlobalesCol,
  ...
  UnitRemotaConsulta, UnitVisacionRetirosCaja, UnitDeclaracion,
  UnitImagenJpeg;
...
begin
        ...
        //Registro de Delcaración de Movimientos de Operaciones En Efectivo
        if ((TBilletes + TMonedas) >= _vMinimoSARLAFT) then
        begin
...
begin
       ...
       begin
          ...
          begin
            ...
            ParamByName('CODIGO').AsString := '110505000000000000';
            ExecQuery;
...
begin
        ...
        if CapOperacion = 'C' then
           ...
           EdNuevoSaldoCap.Caption := FormatCurr('#,#0.00',(Saldo - TGeneral));
        ///Registro de Declaración de Movimientos
        {if (TBilletes + TMonedas) >= _vMinimoSARLAFT then
...
begin
        ...
        //Buscar Información de Dirección y Telefono Asociado
...
begin
        ...
        TBilletes := EdTotalBilletesCapAg.Value;
        TGeneral := TBilletes + TMonedas + TCheques;
        //Registro declaración de Movimientos
        {if (TBilletes + TMonedas) >= _vMinimoSARLAFT then
...
// TODO: Proceso por Realizar;
        ...
        if (Status = 230) then
        begin
              MessageDlg('Número de Talón ya Usado!!, por favor confirme la operación',mtInformation,[mbok],0);
              Result := False;
              Exit;
        end;
