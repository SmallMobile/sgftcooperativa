...
// Actualizar Edad por Arrastre
                 // Buscar Edad Según Evaluación
                 with IBSQL3 do begin
                    Close;
                    SQL.Clear;
                    SQL.Add('SELECT ID_EVALUACION FROM "col$colocacion" c WHERE ');
                    SQL.Add('c.ID_AGENCIA = :ID_AGENCIA and c.ID_COLOCACION = :ID_COLOCACION');
                    ParamByName('ID_AGENCIA').AsInteger := IBQuery1.Fieldbyname('ID_AGENCIA').AsInteger;
                    ParamByName('ID_COLOCACION').AsString := IBQuery1.FieldByName('ID_COLOCACION').AsString;
                    try
                     ExecQuery;
...
//Comparar Saldos y Contabilizar
               ...
               while not IBSQL3.Eof do begin
                ...
                if IBSQL3.FieldByName('PINTERES_REC').AsCurrency > 0 then begin
                  ...
                  AR^.codigo := '418028000000000000'; //Nuevo Código
...
//          end;
          ...
          while not IBQuery1.Eof  do begin
           ...
           with IBSQL3 do begin
            ...
            try
             ExecQuery;
             frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Leyendo Porcentajes Provision';
            except
             MessageDlg('Error al Buscar Datos Para Aplicar Provisión',mtError,[mbcancel],0);
             frmPantallaProgreso.Cerrar;
             raise;
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Calc Capital';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Calc Interes';
            Interes := SimpleRoundTo(IBQuery1.FieldByName('CAUSADOS').AsCurrency * (FieldByName('A_INTERESES').AsFloat / 100),0);
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Calc Costas';
            PCostas := SimpleRoundTo(IBQuery1.FieldByName('COSTAS').AsCurrency * (FieldByName('A_COSTAS').AsFloat / 100),0);
            // Valida estado
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Validando Mora';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Validando Calificacion';
           ...
           frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Causacion Anterior';
           IBSQL6.Close;
           IBSQL6.SQL.Clear;
           ...
           frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Causa Mov Tmp';
           IBSQL6.SQL.Clear;
           ...
           frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Capital Vs PCapAcum';
           ...
           frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Interes Vs PIntAcum';
           ...
           frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Costas Vs PCosAcum';
           if PCostas < PCosAcum then
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update Capital';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update Interes';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update Costas';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update RevCapital';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update RevInteres';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update RevCostas';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update GCapital';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update GInteres';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update GCostas';
            ...
            frmPantallaProgreso.Titulo := 'Calculando Provisión ...'+'- Update Provision';
...
{            SQL.ADD('AND "col$causaciondiariatmp".FECHA_DESEMBOLSO = :FECHA');
            ...
            frmPantallaProgreso.Max := Total;
            frmPantallaProgreso.Position := 0;
            frmPantallaProgreso.InfoLabel := 'Procesando Correcion de mora Causación de Colocaciones';
            while not IBQuery1.Eof do
            begin
                frmPantallaProgreso.Position := IBQuery1.RecNo;
                Application.ProcessMessages;
...
// Fin Actualización
        ...
        if RGProceso.ItemIndex = 1 then begin
          ...
          MessageDlg('Proceso Correción de Mora Aplicado con Exito',mtinformation,[mbok],0);
end;
